public class ODESolver
{
    public static void RungeKutta4(ODE ode, float ds)
    {
        ...
        //Henter  verdier av avheninge og uavhengige variabler
        s = ode.getS();     //Uavhengige
        q = ode.getAllQ();  //Avhengige
        ...
        //Oppdaterer de avhengige og uavhengige variabel verdiene
        //på den nye avhengige variable lokasjonen og oppbevarer
        //verdiene i ODE objekt arrayet
        ode.setS(s + ds);
